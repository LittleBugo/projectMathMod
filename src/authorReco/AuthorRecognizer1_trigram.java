...
public class AuthorRecognizer1_trigram extends AuthorRecognizerAbstractClass {
	...
	public static void main(String[] args) {
		...
		try {
			...
			mot.writeFile("","data/small_author_corpus/validation/authors_100sentences_hyp1_tri.txt",false);
			String temoin = "nothing here";
			while (scan.hasNextLine())
			{
				temoin = scan.nextLine();
				mot.writeFile(exo2.recognizeAuthorSentence(temoin) + "\n", "data/small_author_corpus/validation/authors_100sentences_hyp1_tri.txt",true);
			}
